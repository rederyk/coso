...
void DockWidget::create(lv_obj_t* parent) {
    ...
    lv_obj_set_size(dock_container, LV_HOR_RES_MAX, 70);
    ...
    lv_obj_set_style_radius(dock_container, 0, 0);
    lv_obj_set_style_pad_all(dock_container, 5, 0);
...
void DockWidget::show() {
    ...
    lv_anim_set_values(&show_anim, LV_VER_RES_MAX, LV_VER_RES_MAX - 70);
...
void DockWidget::hide() {
    ...
    lv_anim_set_values(&hide_anim, LV_VER_RES_MAX - 70, LV_VER_RES_MAX);
